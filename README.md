...
![Grafico Importação e Exportação do Brasil](graficogeral1.png)
![Grafico Importação e Exportação de municipios](graficomunicipio1.png)
![Grafico Importação e Exportação de municipios(graficomunicipio2.png)
![Grafico Importação e Exportação do Brasil](graficogeral2.png)
